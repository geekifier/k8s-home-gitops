...
With the release of [Flux Operator MCP Server](https://fluxcd.io/blog/2025/05/ai-assisted-gitops/), I was able to integrate my gitops workspace with LLMs. [AGENTS.md](AGENTS.md) contains instructions used by the agents to interact with the cluster.
...
You can see the custom instructions [here](AGENTS.md) (work in progress).
